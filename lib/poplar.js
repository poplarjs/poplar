 ...
 */
Poplar.set = Poplar.prototype.set = function(name, obj) {
  __config[name] = obj;
};
...
Poplar.unset = Poplar.prototype.unset = function(name) {
  delete __config[name];
};

/**
 * Returns the value of name app configuration, where name is one of strings in the app __config table. For example:
