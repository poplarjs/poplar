...
module.exports = invokeValidations;
 ...
 *    }
 */
function invokeValidations(params, accepts) {
          ...
          if (_.isFunction(validatorOpts)) {
            ...
            if (validator && _.isFunction(validator)) {
              ...
              if (!validator.apply(Validator, args)) {
                validationError.add(name, validatorName, validatorOpts.message);
              }
            }
          }
        })
